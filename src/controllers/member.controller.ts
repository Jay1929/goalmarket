...
memberController.getRestauant = async (req: Request, res: Response) => {
  try {
    console.log('getRestauant');
    
    const result = await memberService.getRestauant();
    
    res.status(HttpCode.OK).json(result);
  } catch (err) {
    console.log('Error, getRestauant:', err);
